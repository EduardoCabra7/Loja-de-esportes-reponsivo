...
<body>
  ...
  <!--fim da cabeçalho-->
    ...
    <p>
    <div class="forme" >
        <input type="text" name="" id="numcart"  placeholder="Número do Cartão" >
...
<div class="row align-items-center">
    ...
    <p style="color:#FFF;">A Sport Max será uma loja virtual de produtos esportivos, que ajudará a se conectar com os clientes. Ela apresentará diversas informações que pode compartilhar com o mundo. Mas o objetivo principal é atrair clientes.</p>
