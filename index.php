          ...
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item dropdown" style="color: #fff; background-color: black;">
              ...
              <ul class="dropdown-menu" style="color: #fff; background-color: black;">
                ...
                <li><a class="dropdown-item" style="color: #fff; background-color: black;" href="pesquisa-chuteira.php">Chuteira</a></li>
                <li style="color: #fff; background-color: black;" >
                  <hr class="dropdown-divider">
                </li>
            ...
            <li class="nav-item dropdown" >
              ...
              <ul class="dropdown-menu" style="color: #fff; background-color: black;">
                ...
                <li><a class="dropdown-item" href="protect.php" style="color: #fff; ">Ações do Usuario</a></li>
              </ul>
              <!---->
            </li>
            <!---->
