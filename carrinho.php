  ...
  <header>
    <nav class="navbar navbar-expand-lg " style="background-color: black; color:#FFF;">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="./img/logosite.jpge.jpg" width="200" alt=""></a>
          ...
          <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item dropdown" style="color: #fff; background-color: black;">
              ...
              <ul class="dropdown-menu" style="color: #fff; background-color: black;">
                <li><a class="dropdown-item" style="color: #fff; background-color: black;" href="#">Camisa</a></li>
                <li><a class="dropdown-item" style="color: #fff; background-color: black;" href="#">Chuteira</a></li>
                <li style="color: #fff; background-color: black;" >
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" style="color: #fff; background-color: black;" href="#">Short</a></li>
              </ul>
              <!---->
            </li>
            <!---->
           ...
           <table class= "table table-dark table-hover" >
                ...
                <?php
                    ...
                    $result2 = mysqli_query($con, $seletor2);
                        ...
                        $valor_a_pagar= intval($valor)*intval($quantidade);
                        ?>
                        <tbody>
                        <tr>  
                            ...
                            <td>R$ <?php echo $valor_a_pagar;?>,00</td>
                            
                            <!-- excluir -->
                            <td> <a href="excluir-usuario.php?cod=<?php echo $compras["codprod"]; ?>"> <span style="color:red;" class="material-symbols-outlined">
delete
</span> </a></td>
                        </tr>
                        </tbody>
...
<?php
   ...
   echo "Não a produtos. Vá Comprar Despois volte aqui!!";
