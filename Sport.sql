...
'camisa do cruzeiro I adidas - masculina','299,99','50','1');

insert into produto values(null,"img/vasco.png",
'camisa vasco kappa III - masculina','299,90','40','1');

insert into produto values(null,"img/fluminense.png",
'camisa fluminense III - masculina',' 269,91','20','1');

insert into produto values(null,"img/corinthians.png",
'camisa nike corinthians II',' 249,99','10','1');
...
'chuteira nike phantom gt2 elite campo','2.299,99','70','1');

insert into produto values(null,"img/chuteira4.png" ,
'chuteira x speedportal+','1.999,99','5','1');

insert into produto values(null,"img/chuteira5.png",
'chuteira nike zoom mercurial  9 campo',' 2.299,99','5','1');

insert into produto values(null,"img/short1.png",
'shorts nike sportswear flow masculino','239,99 ','5','1');

insert into produto values(null,"img/short2.png",
'shorts nike los angeles lakers masculino',' 279,99','5','1');
...
'shorts de futebol plus size básico',' 37,10','5','1');

insert into produto values(null,"img/short5.png",
'shorts entrada 22','89,99','5','1');
